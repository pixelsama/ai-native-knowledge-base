...
```bash
python3 scripts/ingest.py file originals/example.pdf --category rendering --title "Example Source"
python3 scripts/ingest.py web --url https://example.com --title "Example Web Source" --category rendering < /tmp/source.md
